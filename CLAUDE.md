...
- Uses EvoTrees random forests with cross-validation
...
- Protein group ML scoring integration using EvoTrees random forests
...
**Features**:
- EvoTrees random forest models trained per CV fold
